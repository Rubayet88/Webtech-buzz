...
<body>
	...
	//$_SESSION['usr'][] =($_POST['aa']);//19
	//$_SESSION['usr'][] = test_input($_POST['Nationalname']);//20
	//$_SESSION['usr'][] = test_input($_POST['TaxnameNo']);//21
	$_SESSION['usr'][] = test_input($_POST['cm']);//22
	$_SESSION['usr'][] = test_input($_POST['inch']);//23
	$_SESSION['usr'][] = test_input($_POST['aReligion']);//24
	$_SESSION['usr'][] = test_input($_POST['Email']);//25
	$_SESSION['usr'][] = test_input($_POST['aNationality']);//26
	$_SESSION['usr'][] = test_input($_POST['citiStatus']);//26
	//$_SESSION['usr'][] = $_POST['dualcitizenship'];//27
	$_SESSION['usr'][] = test_input($_POST['V/H_present']);//28
	$_SESSION['usr'][] = test_input($_POST['R/B/S_present']);//29
	$_SESSION['usr'][] = test_input($_POST['aDistrict']);//30
	$_SESSION['usr'][] = test_input($_POST['policeStat']);//31
	$_SESSION['usr'][] = test_input($_POST['postOffice']);//32
	$_SESSION['usr'][] = test_input($_POST['PV/H_permanent']);//33
	$_SESSION['usr'][] = test_input($_POST['PR/B/S_permanent']);//34
	$_SESSION['usr'][] = test_input($_POST['perDistrict']);//35
	$_SESSION['usr'][] = test_input($_POST['perPoliceStat']);//36
	$_SESSION['usr'][] = test_input($_POST['perPostOffice']);//37
}
