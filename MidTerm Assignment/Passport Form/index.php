				    ...
				    <tr>
					    ...
					    <div class="table1">
							...
							<table>
								...
								<tr>
									...
									<td>
									<input type="text" name="Name" value="<?php if(isset($_SESSION['usr'][2])) {echo $_SESSION['usr'][2];}?>"required>
									</td>
								...
								<tr>
									...
									<td>
									<input type="text" name="FirstName" value="<?php if(isset($_SESSION['usr'][3])) {echo $_SESSION['usr'][3];}?>"required>
									</td>
								</tr>
								<tr>
									<td>Second Part <br>
									...
									<td>
									<input type="text" name="Surname" value="<?php if(isset($_SESSION['usr'][4])) {echo $_SESSION['usr'][4];}?>" required>
									</td>
								...
								<td>Father's name:<i style="color:red" class="error">*</i>
									...
									<td>
									<input type="text" name="Fathername" value="<?php if(isset($_SESSION['usr'][5])) {echo $_SESSION['usr'][5];}?>"required>
									</td>
								</tr>
								<tr>
								...
								<td>Mother's name:<i style="color:red" class="error">*</i>
									...
									<td>
									<input type="text" name="Mothername" value="<?php if(isset($_SESSION['usr'][7])) {echo $_SESSION['usr'][7];}?>"required>
									</td>
								</tr>
								<tr>
								...
								<td>Spouse's name:
									...
									<td>
									<input type="text" name="Spousename" value="<?php if(isset($_SESSION['usr'][11])) {echo $_SESSION['usr'][11];}?>"required>
									</td>
								</tr>
						...
						<table>
							...
							<tr>
								...
								<td><input type="text" name="DOB" value="<?php if(isset($_SESSION['usr'][18])) {echo $_SESSION['usr'][18];}?>"required>
								</td>
							</tr>
							<tr>
								<td>
							...
							<tr>
								...
								<td>
									<input type:"text" name:"aa" value=""required>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<input type:"text" name="NationalnameNo" value=""required>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<input type:"text" name="TaxnameNo" value=""required>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
								<input type="text" name="cm" class="cm" value="<?php if(isset($_SESSION['usr'][22])) {echo $_SESSION['usr'][22];}?>"required>cm
								</td>
								<td>
								<input type="text" name="inch" class="inch" value="<?php if(isset($_SESSION['usr'][23])) {echo $_SESSION['usr'][23];}?>"required> inch
								</td>
							</tr>
							<tr>
								<td>
							...
							<tr>
								...
								<td>
								<input type="text" name="Email" value="<?php if(isset($_SESSION['usr'][24])) {echo $_SESSION['usr'][24];}?>"required>
								</td>
							...
							<tr>
								...
								<td>
									<input type="text" name="V/H_present" value="<?php if(isset($_SESSION['usr'][28])) {echo $_SESSION['usr'][281];}?>"required>
								</td>
							...
							<tr>
								...
								<td>
								  <input type="text" name="R/B/S_present" value="<?php if(isset($_SESSION['usr'][29])) {echo $_SESSION['usr'][29];}?>"required>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									<input type="text" name="PV/H_permanent" value="<?php if(isset($_SESSION['usr'][33])) {echo $_SESSION['usr'][33];}?>"required>
								</td>
							...
							<tr>
								...
								<td>
								  <input type="text" name="PR/B/S_permanent" value="<?php if(isset($_SESSION['usr'][34])) {echo $_SESSION['usr'][34];}?>"required>
								</td>
							</tr>
							<tr>
								<td>District:<i style="color:red" class="error">*</i>
